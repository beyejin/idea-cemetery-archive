...
- [ ] **Step 2: 테스트가 기존 잠금 정책 때문에 실패하는지 확인**
...
- [ ] **Step 3: 링크와 비링크 카드에 동일한 레이아웃 적용**
...
- [ ] **Step 5: 명시적 파일만 커밋하고 main에 push**
